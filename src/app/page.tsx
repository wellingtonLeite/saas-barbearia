        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-[#15151a] border border-white/10 rounded-3xl p-8 flex flex-col">
              ...
              <p className="text-slate-400 text-sm mb-6 h-10">Para barbearias de pequeno porte.</p>
              <div className="text-4xl font-display font-bold text-white mb-8">R$ 49<span className="text-lg text-slate-500">,90/mês</span></div>
              <ul className="space-y-4 mb-8 flex-1">
                <li className="flex gap-3 text-sm"><CheckCircle2 className="text-success shrink-0" size={20} /> Até 3 Barbeiros</li>
                <li className="flex gap-3 text-sm"><CheckCircle2 className="text-success shrink-0" size={20} /> Gestão Financeira DRE</li>
                <li className="flex gap-3 text-sm"><CheckCircle2 className="text-success shrink-0" size={20} /> Gestão de Clientes</li>
                <li className="flex gap-3 text-sm opacity-40"><CheckCircle2 className="text-white/10 shrink-0" size={20} /> Sem Agente IA</li>
              </ul>
              <Link href="/register" className="w-full py-3 rounded-xl bg-white/10 text-white font-bold text-center hover:bg-white/20 transition-colors">Assinar Inicial</Link>
            </div>

            {/* PLANO INTERMEDIÁRIO */}
            <div className="bg-[#15151a] border border-white/10 rounded-3xl p-8 flex flex-col">
              <h3 className="text-xl font-bold text-white mb-2">Intermediário</h3>
              <p className="text-slate-400 text-sm mb-6 h-10">Para equipes em crescimento estruturado.</p>
              <div className="text-4xl font-display font-bold text-white mb-8">R$ 89<span className="text-lg text-slate-500">,90/mês</span></div>
              <ul className="space-y-4 mb-8 flex-1">
                <li className="flex gap-3 text-sm"><CheckCircle2 className="text-success shrink-0" size={20} /> Até 10 Barbeiros</li>
                <li className="flex gap-3 text-sm"><CheckCircle2 className="text-success shrink-0" size={20} /> 2 Filiais (Unidades)</li>
                <li className="flex gap-3 text-sm"><CheckCircle2 className="text-success shrink-0" size={20} /> Mensagens Auto WPP</li>
                <li className="flex gap-3 text-sm"><CheckCircle2 className="text-success shrink-0" size={20} /> Módulo Fidelidade</li>
              </ul>
              <Link href="/register" className="w-full py-3 rounded-xl bg-white/10 text-white font-bold text-center hover:bg-white/20 transition-colors">Assinar Intermediário</Link>
            </div>
            ...
            <div className="bg-[#15151a] border border-primary/50 rounded-3xl p-8 flex flex-col relative transform lg:-translate-y-4 shadow-[0_0_50px_-15px_rgba(139,92,246,0.3)]">
              ...
              <h3 className="text-xl font-bold text-white mb-2 text-primary">Plano VIP</h3>
              <p className="text-slate-400 text-sm mb-6 h-10">Acesso absoluto à tecnologia de Inteligência Artificial.</p>
              <div className="text-4xl font-display font-bold text-white mb-8">R$ 149<span className="text-lg text-slate-500">,90/mês</span></div>
              <ul className="space-y-4 mb-8 flex-1 bg-primary/5 p-4 rounded-xl border border-primary/10">
                ...
                <li className="flex gap-3 text-sm"><CheckCircle2 className="text-primary shrink-0" size={20} /> Barbeiros Ilimitados</li>
                <li className="flex gap-3 text-sm"><CheckCircle2 className="text-primary shrink-0" size={20} /> Filiais Ilimitadas</li>
