  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-5xl flex flex-col items-center animate-fade-in">
        ...
        {/* Cards Section */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl mx-auto animate-slide-up" style={{ animationDelay: "0.2s" }}>
          ...
          >
            ...
            <h2 className="text-2xl font-display font-bold text-gradient-gold mb-3">Barbearia</h2>
            <p className="text-text-secondary leading-relaxed flex-1 relative z-10">
              O coração do seu negócio. Gerencie agenda, estoque, equipe, planos e comissões com facilidade.
            </p>
