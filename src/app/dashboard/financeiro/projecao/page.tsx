import { CashFlowProjectionView } from "@/components/dashboard/CashFlowProjectionView";
...
export default async function ProjecaoFinanceiraPage() {
    ...
    <div className="max-w-5xl mx-auto space-y-6 animate-fade-in p-2 sm:p-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-display font-bold text-white">
            Previsibilidade Financeira & FP&A
          </h1>
          <p className="text-xs text-text-secondary">
            Módulo de Inteligência Financeira e Projeção de Caixa do 88Barber
          </p>
        </div>
      </div>
      ...
      {!hasFinancial ? (
        <UpgradeCard
          ...
          featureName="Fluxo de Caixa Projetado Dinâmico (30/60/90d)"
        />
      ) : (
